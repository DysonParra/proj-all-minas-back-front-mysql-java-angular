/*
 * @fileoverview    {GeneradorPartidaRest} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
import com.project.dev.api.service.GeneradorPartidaService;
import com.project.dev.api.web.rest.assembler.GeneradorPartidaRestAssembler;
...
/**
 * TODO: Definición de {@code GeneradorPartidaRest}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
@Api(value = "GeneradorPartida API")
public class GeneradorPartidaRest {

    private final Logger log = LoggerFactory.getLogger(GeneradorPartidaRest.class);
    private final GeneradorPartidaService entityService;
    private final GeneradorPartidaRestAssembler entityRestAssembler;
     ...
     */
    public GeneradorPartidaRest(GeneradorPartidaService entityService,
            GeneradorPartidaRestAssembler entityRestAssembler) {
    ...
    public CollectionModel<EntityModel<GeneradorPartidaDTO>> getAllEntities() {
        ...
        try {
            ...
            CollectionModel<EntityModel<GeneradorPartidaDTO>> entitiesCollection = new CollectionModel<>(entities);
            entitiesCollection.add(linkTo(methodOn(GeneradorPartidaRest.class).getAllEntities()).withSelfRel());
    ...
    public ResponseEntity<List<GeneradorPartidaDTO>> getAllEntitiesPaged(Pageable pageable) {
    ...
    @GetMapping("/GeneradorPartida/{query}/pages")
    public ResponseEntity<List<GeneradorPartidaDTO>> searchEntitiesPaged(@PathVariable String query, Pageable pageable) {
        ...
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/GeneradorPartida/{query}/pages/" + query);
        return new ResponseEntity<>(page.getContent(), headers, HttpStatus.OK);
    }
