/*
 * @fileoverview    {FicherosProveedorServiceImpl} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
/**
 * TODO: Definición de {@code FicherosProveedorServiceImpl}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public class FicherosProveedorServiceImpl implements FicherosProveedorService {
    ...
    public FicherosProveedorDTO saveUpdate(FicherosProveedorDTO entityDTO) throws Exception {
        ...
        FicherosProveedorDTO actualEntity = entityMapping.obtenerDto(entity);
        return actualEntity;
    }
