/*
 * @fileoverview    {ContratoRest} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
public class ContratoRest {
    ...
    private final ContratoService entityService;
     ...
     */
    public ContratoRest(ContratoService entityService,
    ...
    public ResponseEntity<List<ContratoDTO>> getAllEntitiesPaged(Pageable pageable) {
    ...
    @GetMapping("/Contrato/{query}/pages")
    public ResponseEntity<List<ContratoDTO>> searchEntitiesPaged(@PathVariable String query, Pageable pageable) {
        ...
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/Contrato/{query}/pages/" + query);
        return new ResponseEntity<>(page.getContent(), headers, HttpStatus.OK);
    }
