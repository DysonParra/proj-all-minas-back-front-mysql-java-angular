...
/**
 * TODO: Definición de {@code CierrePartidaRepository}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
@org.springframework.stereotype.Repository
public interface CierrePartidaRepository extends JpaRepository<CierrePartida, Integer> {
     ...
     */
    public List<CierrePartida> findByIntConsecutivo(Integer id);
    ...
    @Query("SELECT m FROM CierrePartida m WHERE m.intConsecutivo LIKE CONCAT('%', :strSearch, '%')")
    public List<CierrePartida> searchEntities(@Param("strSearch") String strSearch);
    ...
    // TODO: Especificar campo de la entidad donde realizar la búsqueda.
    @Query("SELECT m FROM CierrePartida m WHERE m.intConsecutivo LIKE CONCAT('%', :strSearch, '%')")
    public Page<CierrePartida> searchEntities(@Param("strSearch") String strSearch, Pageable pageable);
}
