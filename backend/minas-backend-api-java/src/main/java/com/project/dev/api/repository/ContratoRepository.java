...
/**
 * TODO: Definición de {@code ContratoRepository}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public interface ContratoRepository extends JpaRepository<Contrato, Integer> {
     ...
     */
    public List<Contrato> findByIntIdContrato(Integer id);
    ...
    @Query("SELECT m FROM Contrato m WHERE m.intIdContrato LIKE CONCAT('%', :strSearch, '%')")
    public List<Contrato> searchEntities(@Param("strSearch") String strSearch);
    ...
    // TODO: Especificar campo de la entidad donde realizar la búsqueda.
    @Query("SELECT m FROM Contrato m WHERE m.intIdContrato LIKE CONCAT('%', :strSearch, '%')")
    public Page<Contrato> searchEntities(@Param("strSearch") String strSearch, Pageable pageable);
}
