...
import com.project.dev.api.web.rest.assembler.TemporalRestAssembler;
...
/**
 * TODO: Definición de {@code TemporalRest}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
@Api(value = "Temporal API")
public class TemporalRest {

    private final Logger log = LoggerFactory.getLogger(TemporalRest.class);
    private final TemporalService entityService;
    private final TemporalRestAssembler entityRestAssembler;
     ...
     */
    public TemporalRest(TemporalService entityService,
            TemporalRestAssembler entityRestAssembler) {
    ...
    public CollectionModel<EntityModel<TemporalDTO>> getAllEntities() {
        ...
        try {
            ...
            CollectionModel<EntityModel<TemporalDTO>> entitiesCollection = new CollectionModel<>(entities);
            entitiesCollection.add(linkTo(methodOn(TemporalRest.class).getAllEntities()).withSelfRel());
    ...
    public ResponseEntity<List<TemporalDTO>> getAllEntitiesPaged(Pageable pageable) {
    ...
    @GetMapping("/Temporal/{query}/pages")
    public ResponseEntity<List<TemporalDTO>> searchEntitiesPaged(@PathVariable String query, Pageable pageable) {
        ...
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/Temporal/{query}/pages/" + query);
        return new ResponseEntity<>(page.getContent(), headers, HttpStatus.OK);
    }
