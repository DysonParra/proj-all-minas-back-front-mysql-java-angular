/*
 * @fileoverview    {ConsecutivoDiarioRepository} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
/**
 * TODO: Definición de {@code ConsecutivoDiarioRepository}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public interface ConsecutivoDiarioRepository extends JpaRepository<ConsecutivoDiario, String> {
     ...
     */
    public List<ConsecutivoDiario> findByStrRfid(String id);
