/*
 * @fileoverview    {GeneradorPartidaServiceImpl} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
public class GeneradorPartidaServiceImpl implements GeneradorPartidaService {
    ...
    public GeneradorPartidaDTO saveUpdate(GeneradorPartidaDTO entityDTO) throws Exception {
        ...
        GeneradorPartidaDTO actualEntity = entityMapping.obtenerDto(entity);
        return actualEntity;
    }
