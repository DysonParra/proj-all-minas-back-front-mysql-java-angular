...
/**
 * TODO: Definición de {@code CodigoOrigenRepository}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
@org.springframework.stereotype.Repository
public interface CodigoOrigenRepository extends JpaRepository<CodigoOrigen, Integer> {
     ...
     */
    public List<CodigoOrigen> findByIntId(Integer id);
    ...
    @Query("SELECT m FROM CodigoOrigen m WHERE m.intId LIKE CONCAT('%', :strSearch, '%')")
    public List<CodigoOrigen> searchEntities(@Param("strSearch") String strSearch);
    ...
    // TODO: Especificar campo de la entidad donde realizar la búsqueda.
    @Query("SELECT m FROM CodigoOrigen m WHERE m.intId LIKE CONCAT('%', :strSearch, '%')")
    public Page<CodigoOrigen> searchEntities(@Param("strSearch") String strSearch, Pageable pageable);
}
