...
/**
 * TODO: Description of {@code MuestraServiceImpl}.
 *
 * @author Dyson Parra
...
public class MuestraServiceImpl implements GenericService<MuestraDTO> {
    ...
    public Page<MuestraDTO> getAllEntitiesPaged(Pageable pageable) throws Exception {
        log.debug("Solicitud para listar todas las Entidades tipo Muestra con paginación");
    ...
    public MuestraDTO saveUpdate(MuestraDTO entityDTO) throws Exception {
        ...
        MuestraDTO dto = entityMapping.getDto(entity);
        return dto;
    }
