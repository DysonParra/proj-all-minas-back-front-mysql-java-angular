/*
 * @overview        {ControlAccesoServiceImpl}
 *
 * @version         2.0
 *
...
/**
 * TODO: Description of {@code ControlAccesoServiceImpl}.
 *
 * @author Dyson Parra
...
public class ControlAccesoServiceImpl implements GenericService<ControlAccesoDTO> {
    ...
    public Page<ControlAccesoDTO> getAllEntitiesPaged(Pageable pageable) throws Exception {
        log.debug("Solicitud para listar todas las Entidades tipo ControlAcceso con paginación");
    ...
    public ControlAccesoDTO saveUpdate(ControlAccesoDTO entityDTO) throws Exception {
        ...
        ControlAccesoDTO dto = entityMapping.getDto(entity);
        return dto;
    }
