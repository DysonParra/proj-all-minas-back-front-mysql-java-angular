...
/**
 * TODO: Description of {@code ContratoServiceImpl}.
 *
 * @author Dyson Parra
...
public class ContratoServiceImpl implements GenericService<ContratoDTO> {
    ...
    public Page<ContratoDTO> getAllEntitiesPaged(Pageable pageable) throws Exception {
        log.debug("Solicitud para listar todas las Entidades tipo Contrato con paginación");
    ...
    public ContratoDTO saveUpdate(ContratoDTO entityDTO) throws Exception {
        ...
        ContratoDTO dto = entityMapping.getDto(entity);
        return dto;
    }
