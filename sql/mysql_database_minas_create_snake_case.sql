...
CREATE TABLE IF NOT EXISTS `parque` (
    ...
    PRIMARY KEY (`id_parque` ASC)
);

CREATE TABLE IF NOT EXISTS `producto` (
    `id_producto`                       INT                 NOT NULL,
    `producto`                          VARCHAR(100)            NULL,
    PRIMARY KEY (`id_producto` ASC)
);
