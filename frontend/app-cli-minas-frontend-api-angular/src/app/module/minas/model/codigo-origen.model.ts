/*
 * @fileoverview    {CodigoOrigenViewModel}
 *
 * @version         2.0
 *
...
/**
 * TODO: Description of {@code CodigoOrigenViewModel}.
 *
 * @author Dyson Parra
...
export class CodigoOrigenViewModel extends GenericViewModel<number> {
     ...
     *
     */
    public newEntity(): CodigoOrigenViewModel {
        return new CodigoOrigenViewModel();
    }
