/*
 * @fileoverview    {ProductoViewModel}
 *
 * @version         2.0
 *
...
/**
 * TODO: Description of {@code ProductoViewModel}.
 *
 * @author Dyson Parra
...
export class ProductoViewModel extends GenericViewModel<number> {

    @Id
    @NotNull
    public intIdProducto: number;
     ...
     *
     */
    public newEntity(): ProductoViewModel {
