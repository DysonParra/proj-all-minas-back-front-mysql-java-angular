...
/**
 * TODO: Description of {@code ParqueViewModel}.
 *
 * @author Dyson Parra
...
export class ParqueViewModel extends GenericViewModel<number> {

    @Id
    @NotNull
    public intIdParque: number;
    @NotNull
    public strNombreParque: string;
     ...
     *
     */
    public newEntity(): ParqueViewModel {
        return new ParqueViewModel();
    }
