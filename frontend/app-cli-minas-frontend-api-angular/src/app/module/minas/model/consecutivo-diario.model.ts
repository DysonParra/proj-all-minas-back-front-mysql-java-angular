...
/**
 * TODO: Description of {@code ConsecutivoDiarioViewModel}.
 *
 * @author Dyson Parra
...
export class ConsecutivoDiarioViewModel extends GenericViewModel<number> {

    @Id
    @NotNull
    public strRfid: string;
    @NotNull
    public intNroTiquete: number;
    @NotNull
    public intConsecutivoDia: number;

    /**
     * TODO: Description of method {@code newEntity}.
     *
     */
    public newEntity(): ConsecutivoDiarioViewModel {
        return new ConsecutivoDiarioViewModel();
    }
