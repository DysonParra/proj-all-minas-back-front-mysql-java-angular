...
/**
 * TODO: Description of {@code TituloMineroViewModel}.
 *
 * @author Dyson Parra
...
export class TituloMineroViewModel extends GenericViewModel<number> {

    @Id
    @NotNull
    public strIdTitulo: string;
    @NotNull
     ...
     *
     */
    public newEntity(): TituloMineroViewModel {
        return new TituloMineroViewModel();
    }
