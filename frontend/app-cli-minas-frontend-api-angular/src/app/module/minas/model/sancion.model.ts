...
/**
 * TODO: Description of {@code SancionViewModel}.
 *
 * @author Dyson Parra
...
export class SancionViewModel extends GenericViewModel<number> {

    @Id
    @NotNull
    public intNumero: number;
    public strItem: string;
    public bitSancionConductor: boolean;
    public bitSancionVehiculo: boolean;
     ...
     *
     */
    public newEntity(): SancionViewModel {
        return new SancionViewModel();
    }
