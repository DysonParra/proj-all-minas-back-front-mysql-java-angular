...
/**
 * TODO: Description of {@code GeneradorPartidaViewModel}.
 *
 * @author Dyson Parra
...
export class GeneradorPartidaViewModel extends GenericViewModel<number> {
     ...
     *
     */
    public newEntity(): GeneradorPartidaViewModel {
        return new GeneradorPartidaViewModel();
    }
