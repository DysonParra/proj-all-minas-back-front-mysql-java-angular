/*
 * @fileoverview    {IndicadorViewModel}
 *
 * @version         2.0
 *
...
/**
 * TODO: Description of {@code IndicadorViewModel}.
 *
 * @author Dyson Parra
...
export class IndicadorViewModel extends GenericViewModel<number> {

    @Id
    @NotNull
    public strCodigo: string;
    public strNombre: string;
    public strTamanoTrama: string;
    public strPosicionInicial: string;
    public strTotalDatosPeso: string;
    public strCaracterFinTrama: string;
    public strCaracterInicioTrama: string;

    /**
     * TODO: Description of method {@code newEntity}.
     *
     */
    public newEntity(): IndicadorViewModel {
